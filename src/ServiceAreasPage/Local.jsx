...
const REASONS = [
  {
    ...
    desc: "We're based in Austin — not dispatched from out of state. When you call, a local crew is on the way fast.",
  },
  {
    icon: <Map size={22} />,
    title: "Local Roofing Knowledge",
    desc: "We know Austin weather — the hail seasons, the summer heat, the storm patterns. That knowledge shows in every job we do.",
  },
  {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-[#6B7280] text-[0.95rem] leading-relaxed mb-10">
              ...
              Austin-based crew that knows these neighborhoods, these streets, and what
          ...
          <div className="rounded-2xl overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.1)]">
            <img
              ...
              alt="Apex Roofing crew serving Austin area homeowners"
