        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative pt-6 pb-8 px-4">
            <div className="rounded-2xl overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.1)]">
              <img
                ...
                alt="PrimeShield Roofing crew on a Springfield home"
          ...
          <div className="flex flex-col">
            ...
            <h2 className="font-display font-extrabold text-[#111827]
              ...
              <span className="text-[#1A3C6E]">Springfield Homeowners Trust.</span>
            </h2>
            ...
            <p className="text-[#6B7280] text-[0.95rem] leading-relaxed mb-10">
              ...
              their work seriously. We show up when we say we will, communicate clearly
              throughout the job, and stand behind everything we install.
            </p>
