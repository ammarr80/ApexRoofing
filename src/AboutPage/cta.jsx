    ...
    <section className="bg-[#1A3C6E] py-24 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6">
        ...
        <h2 className="font-display font-extrabold text-white
          ...
          Ready to Work With a Roofer<br />
          <span className="text-[#F97316]">You Can Actually Trust?</span>
        </h2>

        <p className="text-white/60 text-[1rem] leading-relaxed mb-10 max-w-lg">
          Call Apex Roofing today for a free, no-obligation estimate. We'll come to your
          property, assess your roof honestly, and tell you exactly what it needs —
