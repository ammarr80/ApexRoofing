        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            <h2 className="font-display font-extrabold text-[#111827]
              ...
              Roofing Services Across<br />Austin & Surrounding Areas
            </h2>
            <p className="text-[#6B7280] text-[0.95rem] leading-relaxed mb-8">
              ...
              Austin and the greater metro area. If you're within 40 miles of downtown Austin,
          ...
          <div className="rounded-2xl overflow-hidden border border-[#E5E7EB] shadow-sm h-80">
            <iframe
              title="Apex Roofing — Austin, TX Service Area"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              loading="lazy"
