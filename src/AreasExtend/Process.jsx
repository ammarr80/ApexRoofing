...
export default function Process({ data, area }) {
  return (
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="mb-14">
          ...
          <h2 className="font-display font-extrabold text-[#111827]
            ...
            Getting Your {area.city} Roof Serviced
          </h2>
          <p className="text-[#6B7280] text-[0.95rem] leading-relaxed max-w-lg">
            Four straightforward steps — you'll know exactly what to expect from your first call to the final walkthrough.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
          {data.map((s, i) => (
            <div key={s.step}
              className="relative bg-[#F9FAFB] border border-[#E5E7EB] rounded-2xl p-6
